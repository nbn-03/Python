...
## Tổng kết.
- **qua 13 bài học vừa qua đã cung cấp nền cơ bản về python để người học phát triển. python là một ngôn ngữ bậc cao ứng dụng rất nhiều trong công việc, cuộc sống không vì vậy mỗi người học python không thể nắm hết toàn bộ kiến thức về python chỉ có thể mở rộng thêm kiến thức, hiểu biết trong quá trình làm việc với python**
