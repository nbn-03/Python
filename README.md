...
- slicing là tính năng cho phép bạn lấy 1 phần gồm nhiều kí tự (phần tử) trong chuỗi. lệnh: **ten_chuoi[start:stop:step]**. nếu không truyền đối số cho stop và step và start nó sẽ tự động stop: chỉ số cuối của chuỗi+1, step: 1, start: chỉ số bắt đầu. đảo ngược chuỗi thì step là số âm.
...
- nối list sử dụng phép cộng "+". ví dụ: <br> ![image](https://github.com/nbn-03/Python/assets/98254107/116b3167-5512-4872-a447-32aa265a4548)
...
### b. strings
- lấy bảng chữ cái: <br> ![image](https://github.com/nbn-03/Python-for-beginner/assets/98254107/f38dbfb2-8801-42f1-90a4-5864bb36dc39)
